 ...
 **/
LCGPB_FINAL @interface LCGPBAnyRoot : LCGPBRootObject
@end

#pragma mark - LCGPBAny

typedef LCGPB_ENUM(LCGPBAny_FieldNumber) {
  LCGPBAny_FieldNumber_TypeURL = 1,
  LCGPBAny_FieldNumber_Value = 2,
};
 ...
 *     }
 **/
LCGPB_FINAL @interface LCGPBAny : LCGPBMessage
