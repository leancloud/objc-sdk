 ...
 **/
LCGPB_FINAL @interface LCGPBFieldMaskRoot : LCGPBRootObject
@end

#pragma mark - LCGPBFieldMask

typedef LCGPB_ENUM(LCGPBFieldMask_FieldNumber) {
  LCGPBFieldMask_FieldNumber_PathsArray = 1,
};
 ...
 **/
LCGPB_FINAL @interface LCGPBFieldMask : LCGPBMessage
