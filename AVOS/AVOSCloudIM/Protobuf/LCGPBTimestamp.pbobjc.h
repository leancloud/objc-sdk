 ...
 **/
LCGPB_FINAL @interface LCGPBTimestampRoot : LCGPBRootObject
@end

#pragma mark - LCGPBTimestamp

typedef LCGPB_ENUM(LCGPBTimestamp_FieldNumber) {
  LCGPBTimestamp_FieldNumber_Seconds = 1,
  LCGPBTimestamp_FieldNumber_Nanos = 2,
};
 ...
 **/
LCGPB_FINAL @interface LCGPBTimestamp : LCGPBMessage
