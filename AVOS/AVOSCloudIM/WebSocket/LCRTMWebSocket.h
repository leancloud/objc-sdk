 ...
 */
-(void)websocketDidConnect:(nonnull LCRTMWebSocket*)socket;
 ...
 */
-(void)websocketDidDisconnect:(nonnull LCRTMWebSocket*)socket error:(nullable NSError*)error;
 ...
 */
-(void)websocket:(nonnull LCRTMWebSocket*)socket didReceiveMessage:(nonnull NSString*)string;
...
/**
 Use for SSL pinning.
 */
@property(nonatomic, strong, nullable)LCRTMSecurity *security;
