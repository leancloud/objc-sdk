...
#define LCIM_FIELD_LAST_DELIVERED_AT    @"last_delivered_at"
#define LCIM_FIELD_LAST_READ_AT         @"last_read_at"
...
#define LCIM_SQL_INSERT_CONVERSATION                           \
    @"INSERT OR REPLACE INTO " LCIM_TABLE_CONVERSATION  @" ("  \
        ...
        LCIM_FIELD_LAST_DELIVERED_AT    @", " /* Version 3 */  \
        LCIM_FIELD_LAST_READ_AT         @", " /* Version 3 */  \
...
#define LCIM_SQL_UPDATE_CONVERSATION_FIELD_FORMAT   \
    @"UPDATE " LCIM_TABLE_CONVERSATION @" "         \
    @"SET \"%@\" = ? " LCIM_SQL_CONVERSATION_WHERE_CLAUSE
