...
@class AVIMSemanticVersion;
@class AVIMSessionCommand;
@class AVIMSystemInfo;
...
typedef LCGPB_ENUM(AVIMDeviceType) {
  AVIMDeviceType_Unknown = 0,
  AVIMDeviceType_Android = 1,
  AVIMDeviceType_Ios = 2,
};
 ...
 * the time this source was generated.
 **/
BOOL AVIMDeviceType_IsValidValue(int32_t value);
 ...
 **/
LCGPB_FINAL @interface AVIMMessagesProtoOrigRoot : LCGPBRootObject
@end

#pragma mark - AVIMSemanticVersion

typedef LCGPB_ENUM(AVIMSemanticVersion_FieldNumber) {
  AVIMSemanticVersion_FieldNumber_Major = 1,
  AVIMSemanticVersion_FieldNumber_Minor = 2,
  AVIMSemanticVersion_FieldNumber_Patch = 3,
  AVIMSemanticVersion_FieldNumber_PreRelease = 4,
  AVIMSemanticVersion_FieldNumber_Build = 5,
};

LCGPB_FINAL @interface AVIMSemanticVersion : LCGPBMessage

@property(nonatomic, readwrite) int32_t major;

@property(nonatomic, readwrite) BOOL hasMajor;
@property(nonatomic, readwrite) int32_t minor;

@property(nonatomic, readwrite) BOOL hasMinor;
@property(nonatomic, readwrite) int32_t patch;

@property(nonatomic, readwrite) BOOL hasPatch;
@property(nonatomic, readwrite, copy, null_resettable) NSString *preRelease;
/** Test to see if @c preRelease has been set. */
@property(nonatomic, readwrite) BOOL hasPreRelease;
...
typedef LCGPB_ENUM(AVIMAndroidVersion_FieldNumber) {
  AVIMAndroidVersion_FieldNumber_Codename = 1,
  AVIMAndroidVersion_FieldNumber_ApiLevel = 2,
};

LCGPB_FINAL @interface AVIMAndroidVersion : LCGPBMessage

@property(nonatomic, readwrite, copy, null_resettable) NSString *codename;
/** Test to see if @c codename has been set. */
@property(nonatomic, readwrite) BOOL hasCodename;

@property(nonatomic, readwrite, copy, null_resettable) NSString *apiLevel;
/** Test to see if @c apiLevel has been set. */
...
typedef LCGPB_ENUM(AVIMSystemInfo_FieldNumber) {
  AVIMSystemInfo_FieldNumber_DeviceType = 1,
  AVIMSystemInfo_FieldNumber_OsVersion = 2,
  AVIMSystemInfo_FieldNumber_AndroidVersion = 3,
  AVIMSystemInfo_FieldNumber_IsEmulator = 4,
};

LCGPB_FINAL @interface AVIMSystemInfo : LCGPBMessage

@property(nonatomic, readwrite) AVIMDeviceType deviceType;

@property(nonatomic, readwrite) BOOL hasDeviceType;
@property(nonatomic, readwrite, strong, null_resettable) AVIMSemanticVersion *osVersion;
/** Test to see if @c osVersion has been set. */
@property(nonatomic, readwrite) BOOL hasOsVersion;

@property(nonatomic, readwrite, strong, null_resettable) AVIMAndroidVersion *androidVersion;
/** Test to see if @c androidVersion has been set. */
@property(nonatomic, readwrite) BOOL hasAndroidVersion;

@property(nonatomic, readwrite) BOOL isEmulator;

@property(nonatomic, readwrite) BOOL hasIsEmulator;
@end
...
LCGPB_FINAL @interface AVIMJsonObjectMessage : LCGPBMessage
...
LCGPB_FINAL @interface AVIMUnreadTuple : LCGPBMessage
...
LCGPB_FINAL @interface AVIMLogItem : LCGPBMessage
...
LCGPB_FINAL @interface AVIMConvMemberInfo : LCGPBMessage
...
typedef LCGPB_ENUM(AVIMLoginCommand_FieldNumber) {
  AVIMLoginCommand_FieldNumber_SystemInfo = 1,
};

LCGPB_FINAL @interface AVIMLoginCommand : LCGPBMessage

@property(nonatomic, readwrite, strong, null_resettable) AVIMSystemInfo *systemInfo;
...
typedef LCGPB_ENUM(AVIMLoggedinCommand_FieldNumber) {
  AVIMLoggedinCommand_FieldNumber_PushDisabled = 1,
};

LCGPB_FINAL @interface AVIMLoggedinCommand : LCGPBMessage

@property(nonatomic, readwrite) BOOL pushDisabled;

@property(nonatomic, readwrite) BOOL hasPushDisabled;
@end
...
LCGPB_FINAL @interface AVIMDataCommand : LCGPBMessage
...
typedef LCGPB_ENUM(AVIMSessionCommand_FieldNumber) {
  ...
  AVIMSessionCommand_FieldNumber_SystemInfo = 20,
};

LCGPB_FINAL @interface AVIMSessionCommand : LCGPBMessage
...
LCGPB_FINAL @interface AVIMErrorCommand : LCGPBMessage
...
LCGPB_FINAL @interface AVIMDirectCommand : LCGPBMessage
...
LCGPB_FINAL @interface AVIMAckCommand : LCGPBMessage
...
LCGPB_FINAL @interface AVIMUnreadCommand : LCGPBMessage
...
typedef LCGPB_ENUM(AVIMConvCommand_FieldNumber) {
  ...
  AVIMConvCommand_FieldNumber_UniqueId = 19,
  ...
  AVIMConvCommand_FieldNumber_Existing = 32,
...
LCGPB_FINAL @interface AVIMConvCommand : LCGPBMessage
...
@property(nonatomic, readwrite) BOOL queryAllMembers;

@property(nonatomic, readwrite) BOOL hasQueryAllMembers;
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<AVIMMaxReadTuple*> *maxReadTuplesArray;
/** The number of items in @c maxReadTuplesArray without causing the array to be created. */
@property(nonatomic, readonly) NSUInteger maxReadTuplesArray_Count;
...
@property(nonatomic, readwrite) BOOL existing;

@property(nonatomic, readwrite) BOOL hasExisting;
...
LCGPB_FINAL @interface AVIMRoomCommand : LCGPBMessage
...
LCGPB_FINAL @interface AVIMLogsCommand : LCGPBMessage
...
LCGPB_FINAL @interface AVIMRcpCommand : LCGPBMessage
...
LCGPB_FINAL @interface AVIMReadTuple : LCGPBMessage
...
LCGPB_FINAL @interface AVIMMaxReadTuple : LCGPBMessage
...
LCGPB_FINAL @interface AVIMReadCommand : LCGPBMessage
...
LCGPB_FINAL @interface AVIMPresenceCommand : LCGPBMessage
...
LCGPB_FINAL @interface AVIMReportCommand : LCGPBMessage
...
LCGPB_FINAL @interface AVIMPatchItem : LCGPBMessage
...
LCGPB_FINAL @interface AVIMPatchCommand : LCGPBMessage
...
LCGPB_FINAL @interface AVIMPubsubCommand : LCGPBMessage
...
LCGPB_FINAL @interface AVIMBlacklistCommand : LCGPBMessage
...
typedef LCGPB_ENUM(AVIMGenericCommand_FieldNumber) {
  ...
  AVIMGenericCommand_FieldNumber_LoggedinMessage = 117,
};

LCGPB_FINAL @interface AVIMGenericCommand : LCGPBMessage
...
@property(nonatomic, readwrite, strong, null_resettable) AVIMLoggedinCommand *loggedinMessage;
/** Test to see if @c loggedinMessage has been set. */
@property(nonatomic, readwrite) BOOL hasLoggedinMessage;
