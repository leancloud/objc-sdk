 ...
 **/
LCGPB_FINAL @interface LCGPBDurationRoot : LCGPBRootObject
@end

#pragma mark - LCGPBDuration

typedef LCGPB_ENUM(LCGPBDuration_FieldNumber) {
  LCGPBDuration_FieldNumber_Seconds = 1,
  LCGPBDuration_FieldNumber_Nanos = 2,
};
 ...
 **/
LCGPB_FINAL @interface LCGPBDuration : LCGPBMessage
